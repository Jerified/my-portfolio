...
const Hero = () => {
  return (
    <div className='p-5 h-[calc(100vh-65px)]  flex flex-col items-col items-center justify-center w-full text-white text-xl sm:text-3xl md:text-4xl lg:text-5xl font-medium leading-6 sm:leading-8 lg:leading-[3rem]'>
